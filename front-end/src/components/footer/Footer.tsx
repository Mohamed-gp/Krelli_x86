    ...
    <footer className="mt-40">
      ...
      <div className="container flex justify-between py-6 border-t-2 border-t-[#4561EC] md:flex-row flex-col  items-center text-center gap-y-8">
        <div className="flex justify-between font-semibold gap-6 md:flex-row flex-col">
          <Link to="/about" className="hover:text-[#4561EC] duration-300">About Us</Link>
          <Link to="/about" className="hover:text-[#4561EC] duration-300">Contact us</Link>
          <Link to="/about" className="hover:text-[#4561EC] duration-300">Help</Link>
          <Link to="/about" className="hover:text-[#4561EC] duration-300">Privacy Policy</Link>
          <Link to="/about" className="hover:text-[#4561EC] duration-300">Disclaimer</Link>
        </div>
