...
import { GoogleGenerativeAI } from "@google/generative-ai"; // Import GenerativeAI library
import axios from "axios";
...
const ChatBot = () => {
  ...
  const sendMessageToGPT = async (e, message) => {
    e.preventDefault();
    // google gemini
    // const genAI = new GoogleGenerativeAI(process.env.GOOGLE_SECRET as string);
    // const model = genAI.getGenerativeModel({ model: "gemini-free" }); // Assuming free tier model
    ...
    //   // Extract and return the generated response from response.data.text
    ...
    // }
    // open ai boot
    const apiKey = "sk-proj-psMhcWcWzWvPR1k1xmRkT3BlbkFJHpmkyGcPrDmaXJP1HP6U";
  ...
  return (
    <>
      ...
      {ismodelOpen && (
        <div className="fixed bottom-[calc(4rem+1.5rem)] right-0 mr-4 bg-white p-6 rounded-lg border border-[#e5e7eb] w-[440px] h-[434px]">
          {/* <!-- Heading --> */}
          ...
          {/* <!-- Chat Container --> */}
          <div className="pr-4 max-h-[474px]">
            {/* <!-- Chat Message AI --> */}
          ...
          <div className="flex items-center pt-0">
            <form className="flex items-center justify-center w-full space-x-2">
              ...
              />
              <button
                onClick={(e) => sendMessageToGPT(e, "hello what is my name")}
